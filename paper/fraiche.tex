...
We implemented several different possibilities for balancing the loads of serving clients, getting fresh sensor data, and updating the machine-learned data:
