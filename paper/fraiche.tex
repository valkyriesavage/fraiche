...
\begin{figure}
  \centering
      \includegraphics[width=\linewidth]{freshness.png}
  \caption{\label{fig:freshness}Freshness results.}
\end{figure}

\begin{figure}
  \centering
      \includegraphics[width=\linewidth]{latency_for_schedulers.png}
  \caption{\label{fig:latency}Latency results.}
\end{figure}
